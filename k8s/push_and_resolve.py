...
"""Push an image and emit the pushed digest as output.

This is essentially a modified version of google/containerregistry's
fast_pusher.par, and if this experiment is successful, the fork should
be reconciled.
"""
